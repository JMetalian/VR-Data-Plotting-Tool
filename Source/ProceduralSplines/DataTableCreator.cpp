...
void ADataTableCreator::BeginPlay()
{
	...
	//TODO How to create instance in Unreal Engine?
	AGenericSystem* genericSystemInstance = Cast<AGenericSystem>(runTimeDataTable);
	if (genericSystemInstance)
	{
		genericSystemInstance->SetDataTable(runTimeDataTable);
	}
}
